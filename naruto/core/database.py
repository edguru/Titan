...
if "naruto" in _RUN(_MGCLIENT.list_database_names()):
    _LOG.info(_LOG_STR, "naruto Database Found :) => Now Logging to it...")
else:
    _LOG.info(_LOG_STR, "naruto Database Not Found :( => Creating New Database...")

_DATABASE: AgnosticDatabase = _MGCLIENT["naruto"]
