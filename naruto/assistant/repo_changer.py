...
from naruto import HEROKU_API, setbot
...
async def change_repo(url):
    ...
    author = Actor("naruto", "naruto@harumi.tech")
    committer = Actor("naruto", "naruto@harumi.tech")
...
async def configrepo():
    # config_url = "https://raw.githubusercontent.com/legenhand/naruto-bot-file/master/config/repo.json"
    # cache_path = "naruto/cache/repo.json"
    # if not os.path.exists(cache_path):
    #     urllib.request.urlretrieve(config_url, cache_path)
    # f = open("naruto/cache/repo.json")
...
@setbot.on_callback_query(filters.regex("^naruto"))
